...
TESTS: list[TestCase] = [
    ...
    TestCase(
        ...
        expected_tools=["live_observations", "observations_by_month"],
        forbidden_tools=["compare_seasonal"],
        notes="'peut voir en ce moment' → live_observations + observations_by_month (possibility, not comparison)",
    ),
    TestCase(
        id="live_02",
        category="live",
...
ROBUSTNESS_TESTS: list[TestCase] = [
    ...
    TestCase(
        ...
        expected_tools=["live_observations", "observations_by_month"],
        forbidden_tools=["compare_seasonal"],
        notes="'il y a à voir en ce moment' = possibility → live_observations + observations_by_month",
    ),
    TestCase(
        id="r_live_02",
        category="robustness",
